...
I developed this interactive dashboard using Power BI to reveal key trends in hospital visitor data for informed decision-making. By utilizing DAX for insights into patient demographics and service usage, this project aims to boost operational efficiency and patient satisfaction. This dynamic data visualization tool incorporates data modeling principles and various data sources for effective data transformation. By implementing KPIs and utilizing Power Query, healthcare professionals can explore interactive visuals that enhance resource optimization and improve patient care quality through business intelligence.
...
LinkedIn: [linkedin.com/in/aarthireddyj](https://www.linkedin.com/in/aarthireddyj)
...
Aarthi Reddy Jannapureddy is a Data Analyst with over 3 years of experience specializing in SQL, Power BI, Python, and Excel. She has a strong background in building interactive dashboards and KPI tracking systems that help organizations turn complex data into actionable recommendations. Her expertise lies in improving data accuracy and supporting business decisions through advanced analytics and process automation.